...
#define mqtt_topic_pub "SMART_PROJECT/ESP_05" //broker.mqttdashboard.com
#define mqtt_topic_sub "SMART_PROJECT/ESP_05"
...
void reconnect() {
  ...
  while (!client.connected()) {// Nếu chưa kết nối
    ...
    // Attempt to connect
    if (client.connect("ESP_05",mqtt_user, mqtt_pwd)) { //nếu kết nối đúng 
